...
@section('content')
    <header class="main-header architecture-header subpage-header-size">
        <article class="m-container header-layer-container">
            <div class="row">
                <div class="main-layer col">
                    <div class="text-box">
                        <h1>Egyéb faépítészet</h1>
    ...
    <main class="main">
                        ...
                        <div class="horizontal-card">
                            <div class="row">
                                ...
                                <div class="col-7 pl-0">
                                    <p class="text-highlight mb-0 mt-0">Lorem ipsum</p>
                                    <p>
        ...
        <section class="architecture-second-section">
            <div class="m-container">
                <div class="col-12">
                    <h2 class="text-highlight-darker">Lorem Ipsum</h2>
