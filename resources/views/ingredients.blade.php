...
@section('content')
    <header class="main-header ingredients-header header-after subpage-primary-header-size">
    ...
    <main class="main ingredients-page">
                        ...
                        <div class="horizontal-card">
                            <div class="row">
                                <div class="col-7 pl-0">
                                    <p class="text-highlight">Integer auctor nulla</p>
                                    <p class="">
                                        ...
                                        Etiam et dui nisi. Fusce venenatis ultricies condimentum. Nam venenatis tincidunt neque eu scelerisque. Cras vel tincidunt lectus.
                                ...
                                <div class="col-3">
                                    <figure>
                                        <img class="mr-xl-0" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Alapanyagok">
                                    </figure>
                                </div>
                            </div>
                        </div>
        ...
        <section class="swot-section">
            <div class="m-container">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-7 pl-0">
                            <p class="text-white"><b>Hátrányok</b></p>
                            <p class="text-white">
                            ...
                            <p class="text-white"><b>Előnyök</b></p>
                            <p class="text-white">
                            ...
                            <div class="horizontal-card">
                                ...
                                <div class="row">
                                    <div class="vector-col">
                                        <figure>
                                            <img class="ml-xl-0" src="{{ asset('assets/img/ingredients/vector-1.png') }}" alt="Vector">
                                        </figure>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="vector-col">
                                        <figure>
                                            <img class="ml-xl-0" src="{{ asset('assets/img/ingredients/vector-2.png') }}" alt="Vector">
                                        </figure>
                                    </div>
                                    <div class="col-12 pl-0">
                                        <p class="text-highlight">Lorem</p>
                                ...
                                <div class="row">
                                    <div class="vector-col">
                                        <figure>
                                            <img class="mr-xl-0" src="{{ asset('assets/img/ingredients/vector-3.png') }}" alt="Vector">
                                        </figure>
                                    </div>
                                    <div class="col-12 pl-0">
                                        <p class="text-highlight">Lorem</p>
                                ...
                                <div class="row">
                                    <div class="vector-col">
                                        <figure>
                                            <img class="ml-xl-0" src="{{ asset('assets/img/ingredients/vector-4.png') }}" alt="Vector">
                                        </figure>
                                    </div>
                                    <div class="col-12 pl-0">
                                        <p class="text-highlight">Lorem</p>
