...
@section('content')
    ...
    <main class="main single-page">
                        ...
                        <div class="horizontal-card">
                            <div class="row">
                                <div class="col-12 pl-0">
                                    ...
                                    <a class="btn btn-primary" href="/cookie">Cookie adatok</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="image2-section img-after">
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <h2 class="text-white">Részletes szabályzatunkat itt olvashatja!</h2>
                </div>
            </div>
        </section>
        <section class="company-goals">
            ...
            <div class="m-container">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12 pl-0">
                            <h3 class="text-highlight-darker pt-3">1. Milyen adatokat kezelünk</h3>
                            <p>
                            ...
                            <h3 class="text-highlight-darker">2. Adatok törlése?</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sit amet ultrices erat, non bibendum ligula.
                                Nunc at tellus vitae libero gravida consequat id sed orci. Morbi maximus odio neque, vitae faucibus dolor gravida ac.
                                Proin volutpat, nisl sit amet sodales congue, purus orci pharetra arcu, non aliquet nunc diam a est.
