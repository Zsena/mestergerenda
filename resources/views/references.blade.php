                    ...
                    <div class="row">
                        <div class="horizontal-card">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <figure>
                                        <img class="mr-xl-0" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Referencia">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="horizontal-card">
                            <div class="row">
                                <div class="col-4 pl-0">
                                    <figure>
                                        <img class="ml-xl-0" src="{{ asset('assets/img/about-us/placeholder-bigger.png') }}" alt="Referencia">
                                    </figure>
                                </div>
                                <div class="col-6">
            ...
            <div class="m-container">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col pl-0">
                            <figure>
                                <img onclick="openModal();currentSlide(9)" class="hover-shadow cursor" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Galéria">
                            </figure>
                        </div>
                        <div class="col pl-0">
                            <figure>
                                <img onclick="openModal();currentSlide(10)" class="hover-shadow cursor" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Galéria">
                            </figure>
                        </div>
                        <div class="col pl-0">
                            <figure>
                                <img onclick="openModal();currentSlide(11)" class="hover-shadow cursor" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Galéria">
                            </figure>
                        </div>
                        <div class="col pl-0">
                            <figure>
                                <img onclick="openModal();currentSlide(12)" class="hover-shadow cursor" src="{{ asset('assets/img/about-us/placeholder-small.png') }}" alt="Galéria">
                            </figure>
                        </div>
                    </div>
                </div>
